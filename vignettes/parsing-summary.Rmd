...
file](https://support.pstnet.com/hc/en-us/articles/229354727), and 2) a
plain-text `.txt` file. The rprime package provides a set of functions for
parsing these `.txt` files inside R.
